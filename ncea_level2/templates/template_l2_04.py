...
# -*- coding: utf-8 -*-
#
# template_l2_04.py based on template_master_l2.py
# Introduces: Add 2 x functions. Function 2 has data-type testing and +=1
#   Value of data can be passed at cli using -s= or --stuff=
#   with error handling if string passed is a not an integer.
#   Exception information: https://docs.python.org/3/library/exceptions.html
#   Log Function 2.
#
...
_program_ = "Functions"  # "template_l2_04.py"
_version_ = "1.0"
_date_ = "2016-10-25"
...
To check code style:
Linux...
$ python3 -m pep8 --statistic --ignore=E701 template_l2_04.py
Install pep8 on Linux: $ sudo apt-get install python3-pep8
Windows...
> python -m pep8 --statistic --ignore=E701 template_l2_04.py

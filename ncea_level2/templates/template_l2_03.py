...
# -*- coding: utf-8 -*-
#
# template_l2_03.py based on template_master_l2.py
# Introduces: check python 3 minimum version. Includes a for loop countdown.
#
...
_program_ = "Check_Python_Min_Version"  # template_l2_03.py"
_version_ = "1.0"
_date_ = "2016-10-25"
...
To check code style:
Linux...
$ python3 -m pep8 --statistic --ignore=E701 template_l2_03.py
Install pep8 on Linux: $ sudo apt-get install python3-pep8
Windows...
> python -m pep8 --statistic --ignore=E701 template_l2_03.py

...
# -*- coding: utf-8 -*-
#
# Sphere_Calculator. template_l2_08.py based on template_master_l2.py
# Introduces: Get floating point entry to get sphere radius.
# Use Functions to determine surface area and volume of sphere.
#
...
_program_ = "Sphere_Calculator"  # "template_l2_08.py"
_version_ = "1.0"
_date_ = "2016-10-25"
_author_ = "Ian Stewart"
_copyright_ = "© https://creativecommons.org/licenses/by/4.0/"
_description_ = ("When provided with the a value for the radius, the sphere \n"
...
def main(data=radius, log=log, in_file=input_file, out_file=output_file):
    ...
    radius = get_float_entry(data, text="Enter radius of the sphere")

    if debug: print("\nPerforming surface area calculation...")
    surface = calculate_surface(radius)
    print("Sphere Surface Area: {:g}".format(surface))

    if debug: print("\nPerforming volume calculation...")
    volume = calculate_volume(radius)
    print("Sphere Volume: {:g}".format(volume))

    append_logfile("Radius:{:g}, Surface:{:g}, Volume:{:g}"
                   .format(radius, surface, volume))
...
To check code style:
Linux...
$ python3 -m pep8 --statistic --ignore=E701 template_l2_08.py
Install pep8 on Linux: $ sudo apt-get install python3-pep8
Windows...
> python -m pep8 --statistic --ignore=E701 template_l2_08.py

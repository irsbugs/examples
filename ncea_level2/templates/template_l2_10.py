...
# -*- coding: utf-8 -*-
#
# Circle_Plotter. template_l2_10.py based on template_master_l2.py
...
_program_ = "Circle_Plotter"  # "template_l2_10.py"
_version_ = "1.0"
_date_ = "2016-10-25"
...
To check code style:
Linux...
$ python3 -m pep8 --statistic --ignore=E701 template_l2_10.py
Install pep8 on Linux: $ sudo apt-get install python3-pep8
Windows...
> python -m pep8 --statistic --ignore=E701 template_l2_10.py

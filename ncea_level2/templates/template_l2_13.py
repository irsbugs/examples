...
# -*- coding: utf-8 -*-
#
# Sphere_Litre_Plotter. template_l2_13.py based on template_master_l2.py
# Introduces: Get integer entry for litres. Use functions to calculate
# radius, diameter, and circumference, of sphere holding this volume.
...
_program_ = "Sphere_Litre_Plotter"  # "template_l2_13.py"
_version_ = "1.0"
_date_ = "2016-10-25"
...
def main(data=volume, sample=sample, log=log, in_file=input_file,
    ...
    prompt = "Enter volume of the sphere in litres"
    ...
    print("{: <18}{: <18}{: <18}{: <18}"
          .format("Volume(litres)", "Radius(cm)", "Diameter(cm)",
                  "Circumference(cm)"))
...
def calculate_radius(volume):
    ...
    Return the radius
    """
    radius = ((3 * (volume / (4 * math.pi))) ** (1 / 3)) * 10
    return radius
...
def help():
    ...
    print("Arguments...")
    print("  -v=, --volume=[VALUE]      Volume of sphere in litres.")

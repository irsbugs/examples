...
def main(data=volume_prompt, sample=sample):
    ...
    volume = get_integer_entry(data, text="Enter volume in litres of sphere")
...
def calculate_sphere_dimension(volume):
    ...
    For units of litres and centimeters, multiple radius algorithm by 10
    """
...
To check code style:
Linux...
$ python3 -m pep8 --statistic --ignore=E701 snip_l2_13_b.py
Install pep8 on Linux: $ sudo apt-get install python3-pep8
Windows...
> python -m pep8 --statistic --ignore=E701 snip_l2_13_b.py

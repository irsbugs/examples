...
def main(data=radius_prompt, sample=sample):
    ...
    for i in range(radius, radius + iteration):
        ...
        circumference, area, volume = calculate_sphere(i)

        print("{: <15g}{: <15g}{: <15g}{: <15g}"
              .format(i, circumference, area, volume))
    print("-" * 53)
...
def calculate_sphere(radius):
    "Calculate sphere circumference, surface area and volume."
    circumference = 2 * math.pi * radius
    surface = 4 * math.pi * radius ** 2
    volume = 4 / 3 * math.pi * radius ** 3
    return circumference, surface, volume
...
To check code style:
Linux...
$ python3 -m pep8 --statistic --ignore=E701 snip_l2_11_b.py
Install pep8 on Linux: $ sudo apt-get install python3-pep8
Windows...
> python -m pep8 --statistic --ignore=E701 snip_l2_11_b.py

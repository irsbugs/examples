...
def locate_prime(integer):
    ...
    for j in range(2, max_value + 1):
        ...
        if integer % j == 0:
            is_prime = False
            break  # or: return is_prime, count
        else:
            continue
...
To check code style:
Linux...
$ python3 -m pep8 --statistic --ignore=E701 snip_l2_21_e.py
Install pep8 on Linux: $ sudo apt-get install python3-pep8
Windows...
> python -m pep8 --statistic --ignore=E701 snip_l2_21_e.py

...
"""
Fibonacci series - tkinter as .pyw file. No console

Fibonacci series with .pyw extension - This will launch the tkinter GUI and
the fibonacci series is displayed by clicking on buttons in the GUI window.
Click on the Window close icon to terminate the program.

While the program does contain print() functions, these are not displayed.
